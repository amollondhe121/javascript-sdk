...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VerbwireApiDocumentation.Body19();
  });
  ...
  describe('Body19', function() {
    it('should create an instance of Body19', function() {
      ...
      //var instane = new VerbwireApiDocumentation.Body19();
      //expect(instance).to.be.a(VerbwireApiDocumentation.Body19);
    });
    ...
    it('should have the property mintSlots (base name: "mintSlots")', function() {
      // uncomment below and update the code to test the property mintSlots
      //var instane = new VerbwireApiDocumentation.Body19();
      //expect(instance).to.be();
    });
