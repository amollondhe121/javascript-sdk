...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VerbwireApiDocumentation.Body23();
  });
  ...
  describe('Body23', function() {
    it('should create an instance of Body23', function() {
      ...
      //var instane = new VerbwireApiDocumentation.Body23();
      //expect(instance).to.be.a(VerbwireApiDocumentation.Body23);
    });
    ...
    it('should have the property payeeAddress (base name: "payeeAddress")', function() {
      // uncomment below and update the code to test the property payeeAddress
      //var instane = new VerbwireApiDocumentation.Body23();
      //expect(instance).to.be();
    });
